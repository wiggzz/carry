"""Harbor adapter for Carry.

This module is loaded by Harbor inside the Runta runtime through --agent.
"""
...
class CarryAgent(BaseAgent):
    """Run the pinned Carry binary inside each Harbor task container."""
    ...
    def _value(self, key: str, default: str | None = None) -> str | None:
        return self._get_env(key) or default
